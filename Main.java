public class Main {
    public static void main(String[] args) {
        ...
        // aqui tinha um menu antes fornecido para que vocês pudessem integrar as
        // funcionalidades implementadas com o menu.
        // isso não tá no critério de avaliação direto, mas eu esperava que o código
        // fosse integrado aqui.
        ...
        int codServico2 = Gerenciador.cadastrarServico("Alinhamento e Balanceamento",
                "Alinhamento de direção e balanceamento das rodas", 60, 120.00);
        ...
        int indiceInexistente = Gerenciador.buscarServicoPorCodigo(Gerenciador.getServicos(),
                Gerenciador.getTotalServicos(), 999);
        ...
        Gerenciador.atualizarServico(codServico1, "Troca de Óleo Sintético",
                "Troca de óleo sintético e filtro do motor", 45, 75.00);
        Gerenciador.listarPecas();
        Gerenciador.listarServicos();
        ...
        int indiceAposRemocao = Gerenciador.buscarPecaPorCodigo(Gerenciador.getPecas(), Gerenciador.getTotalPecas(),
                codPeca2);
        System.out.println("Busca pela peça removida (código " + codPeca2 + ") retornou: " + indiceAposRemocao
                + " (esperado: -1)");
